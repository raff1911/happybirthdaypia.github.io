...
new TypeIt("#teks1", {
  strings: [
    ...
    " ",
    "Saya Hisyam Abdur Rafi pada hari ini Sabtu, 24 Juli 2021 dengan sepenuh hati mengucapkan",
    " ",
    "<b>Selamat Ulang Tahun Yang ke - 21</b>",
    " ",
    "Kepada Suci Alifia Putri Wijaya, semoga kamu panjang umur, dan bahagia selalu. Aamiin. Sekian surat pernyataan dari saya",
    ,
    " ",
...
new TypeIt("#teks2", {
  strings: [
    ...
    "Happy Birthday ya..",
    " ",
    "Ciie udah 21 tahun, semoga di umur yang sekarang kamu bisa jadi pribadi yang lebih baik lagi, lebih rajin, lebih sholehah, dan lebih berbakti.",
    "Maaf ya aku gabisa kasih apa apa. Cuma ini yang bisa aku kasih ke kamu, aku harap kamu suka ya :)",
